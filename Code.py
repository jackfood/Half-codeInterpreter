...
root = tk.Tk()
root.title("Python Code Runner Lite v1.6.2 (cleaned up)")
...
code_entry = scrolledtext.ScrolledText(code_frame, height=12, width=50)
...
result_text = scrolledtext.ScrolledText(root, height=20, width=40, bg="black", fg="white")
